...
(function ( document, window ) {
    ...
    // IMPRESS.JS API
    var impress = window.impress = function ( rootId,panesClass ) {
        ...
        var up= function () {
            var up=activeStep.getActivePane()+1;
            return goto(up)
        };
        var down= function () {
            var down=activeStep.getActivePane()-1;
            return goto(down)
...
(function ( document, window ) {
    ...
    function getActiveRootKey(){
        return 'impress-root-'+document.querySelector('.active.step').id;
