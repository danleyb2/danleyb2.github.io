...
- **Docker & DevOps**: Built a [PyInstaller-to-Docker extension](https://github.com/danleyb2/py-installer-to-docker-desktop-extension) for Docker Desktop, bridging desktop apps into the container ecosystem
...
| [rich-text-editor](https://github.com/danleyb2/rich-text-editor) | LitElement/WebComponents | Lightweight WYSIWYG editor |
| [passmark-cpu](https://github.com/danleyb2/passmark-cpu) | Docker | CPU performance testing container |
